...
namespace TingenWebService.Core.Logger
{
    ...
    internal static class LogMaintenance
    {
        ...
        internal static void VerifySystemLogs(RuntimeSetting runtimeSetting, FrameworkSetting frameworkSetting)
        {
            //// TODO - Trace log here.
        ...
        internal static void ResetSystemLogs(FrameworkSetting frameworkSetting, RuntimeSetting runtimeSetting)
        {
            ...
            //RemoveSystemLogs(frameworkSetting.SysLogRoot, systemFileNames);
