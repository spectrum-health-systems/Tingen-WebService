...
namespace TingenWebService.Core.Framework
{
    ...
    internal class FrwkConfig
    {
        ...
        /// <summary>Build a <see cref="FrwkConfig"/> instance with the specified paths.</summary>
        /// <param name="dataRoot">The root path for data storage.</param>
        /// <param name="avatarSystem">The avatar system identifier.</param>
        /// <returns>A <see cref="FrwkConfig"/> instance with the specified paths.</returns>
