---
uid: Welcome
title: Tingen Web Service API Documentation
keywords: Welcome
---

# About this documentation

This documentation provides information about the [Tingen Web Service](https://github.com/spectrum-health-systems/Tingen-WebService) API.
...
<!-- ORIGINAL TEXT - Just in case we want to use some of this functionality.
